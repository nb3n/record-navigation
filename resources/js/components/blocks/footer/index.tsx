        ...
        <footer className="py-10">
            <div className="mx-auto max-w-7xl px-4 lg:px-8 xl:px-16">
                <div className="flex flex-col gap-6 sm:gap-12">
                        ...
                        <div className="col-span-full lg:col-span-4">
                            <div className="flex animate-in flex-col gap-6 delay-100 duration-1000 ease-in-out fill-mode-both slide-in-from-bottom-10 fade-in">
                                ...
                                <p className="text-base font-normal text-muted-foreground">
                                    ...
                                    solutions. Let's create something amazing
                                    together.
                                </p>
                    ...
                    <p className="animate-in text-center text-sm font-normal text-muted-foreground delay-100 duration-1000 ease-in-out fill-mode-both slide-in-from-bottom-10 fade-in">
